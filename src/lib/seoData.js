...
// AI Insights feed — proactive intelligence items synthesized across modules.
// Internal Link Intelligence data — equity distribution, orphans, weak nodes.
export const linksIntel = {
  equity: [
    { path: "/blog/seo-guide", inlinks: 87, share: 12.4 },
    { path: "/blog/jwt-security", inlinks: 64, share: 9.1 },
    { path: "/", inlinks: 58, share: 8.3 },
    { path: "/docs/api", inlinks: 51, share: 7.3 },
    { path: "/tools/jwt-generator", inlinks: 42, share: 6.0 },
    { path: "/pricing", inlinks: 38, share: 5.4 },
  ],
  orphans: [
    { path: "/changelog", score: 55, words: 1420 },
    { path: "/legal/privacy", score: 48, words: 2100 },
    { path: "/legal/terms", score: 46, words: 1890 },
    { path: "/careers", score: 41, words: 640 },
    { path: "/tools/key-generator", score: 0, words: 0 },
  ],
  weakNodes: [
    { path: "/products/widget", inlinks: 16, note: "High-value page under-linked vs. cluster peers" },
    { path: "/products/gadget", inlinks: 11, note: "Commercial page, thin internal equity" },
    { path: "/docs/guides", inlinks: 12, note: "Hub candidate — currently a leaf" },
  ],
};

export const aiFeed = {
  generated: "2026-09-12T09:40:00Z",
  items: [
    {
      id: "ins-authority",
      kind: "High Impact",
      module: "Links",
      title: "Internal authority is concentrated in informational content.",
      body: "38 commercial pages receive less than 4% of total internal link equity. Rebalancing links from blog hubs to product pages is the single highest-impact structural fix available this cycle.",
      impact: "High",
      confidence: 92,
    },
    {
      ...
      module: "Issues",
      title: "Canonical signals are inconsistent across three route families.",
      body: "The /products, /product, and /products/* families declare conflicting canonicals. A routing-level fix resolves 17 pages simultaneously and frees wasted crawl budget.",
      impact: "High",
      confidence: 88,
    },
    {
      ...
      kind: "Pattern Detected",
      module: "Performance",
      title: "One shared bundle is throttling every product route.",
      body: "A 1.4 MB un-minified vendor bundle loads synchronously on all product templates, driving 78% of poor LCP sessions. Splitting it and deferring the review widget lifts LCP below 2.5s on 214 pages at once.",
      impact: "High",
      confidence: 84,
    },
    {
      ...
      module: "Links",
      title: "12 articles strongly match your API Key Generator but do not link to it.",
      body: "Semantic similarity between these articles and the tool page exceeds 0.81. Adding contextual links could transfer meaningful authority to an orphaned, high-demand tool page.",
      impact: "Medium",
      confidence: 86,
    },
    {
      ...
      kind: "Opportunity",
      module: "Architecture",
      title: "31 of 42 orphan pages hold content worth preserving.",
      body: "Orphans are invisible to crawlers following internal links. Re-linking the 31 substantive pages from topical hubs recovers lost indexation without publishing anything new.",
      impact: "Medium",
      confidence: 79,
    },
    {
      ...
      kind: "Pattern Detected",
      module: "Content",
      title: "The JWT cluster is splitting its own ranking signals.",
      body: "Three pages compete for 'jwt generator' intent. Keeping the tool page as the transactional target and re-scoping the security article consolidates authority on one URL.",
      impact: "Medium",
      confidence: 90,
    },
    {
      ...
      kind: "Opportunity",
      module: "Content",
      title: "OAuth 2.0 flow is a high-demand gap your security hub can own.",
      body: "Demand 78 / difficulty 42 — your JWT cluster already carries topical authority, so an OAuth companion article would inherit relevance from day one.",
      impact: "Medium",
      confidence: 74,
    },
    {
      ...
      kind: "Notice",
      module: "Content",
      title: "38 thin pages are near-duplicates of stronger pages.",
      body: "Consolidating these into canonical versions reduces crawl waste and concentrates ranking signals instead of diluting them across 38 weak URLs.",
      impact: "Low",
      confidence: 71,
    },
    {
      ...
      kind: "Notice",
      module: "Issues",
      title: "Two templates render without an H1.",
      body: "A one-line template fix resolves all 8 affected pages at once — the cheapest remaining win in this crawl.",
      impact: "Low",
      confidence: 96,
    },
  ],
